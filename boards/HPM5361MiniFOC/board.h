...
#if defined(CONSOLE_TYPE_UART) && (BOARD_CONSOLE_TYPE == CONSOLE_TYPE_UART)
...
#define BOARD_LED_GPIO_INDEX GPIO_DI_GPIOY
#define BOARD_LED_GPIO_RED_PIN 0
#define BOARD_LED_GPIO_GREEN_PIN 1
...
#define BOARD_BLDC_ADC_CH_VBUS_1               (2U)
...
#define BOARD_SEI_CTRL SEI_CTRL_0
#define BOARD_SEI_IRQn IRQn_SEI0
